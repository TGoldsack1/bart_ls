...
try:
    ...
    ROUGE_HOME = "/home/acp20tg/bart_ls/fairseq-py/Yale-LILY-SummEval-e26bef9/evaluation/summ_eval/ROUGE-1.5.5/"
    ...
    if not os.path.exists(ROUGE_HOME):
        ...
        subprocess.run(["mv", "Yale-LILY-SummEval-e26bef9/evaluation/summ_eval/ROUGE-1.5.5/", ROUGE_HOME])
        subprocess.run(["rm", "project.tar.gz"])
        subprocess.run(["rm", "-rf", "Yale-LILY-SummEval-e26bef9/"])
except:
